    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navSoteira">
            <ul class="navbar-nav ms-auto align-items-center">
                <li class="nav-item"><a class="nav-link spa-link" href="#inicio">Inicio</a></li>
                <li class="nav-item"><a class="nav-link spa-link" href="#empresa">La Empresa</a></li>
                <li class="nav-item"><a class="nav-link spa-link" href="#servicios">Servicios</a></li>
                <li class="nav-item"><a class="nav-link spa-link" href="#equipo">El Equipo</a></li>
                <li class="nav-item"><a class="nav-link spa-link" href="#contacto">Contacto</a></li>
                <li class="nav-item ms-lg-3">
                    <a class="btn btn-warning fw-bold px-4 shadow-sm spa-link" href="#login">ACCESO</a>
                </li>
            </ul>
        </div>
    </div>
...
<div id="templates" class="d-none">
    ...
    <section id="tpl-inicio">
        <div class="glass-card text-center py-5">
            ...
            <a href="#contacto" class="btn btn-primary spa-link">Contáctanos</a>
        </div>
    </section>

    <section id="tpl-empresa">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-2">
                ...
                <ul class="list-unstyled">
                    <li><a href="#inicio" class="footer-link spa-link">Inicio</a></li>
                    <li><a href="#empresa" class="footer-link spa-link">La Empresa</a></li>
                    <li><a href="#servicios" class="footer-link spa-link">Servicios</a></li>
                </ul>
            </div>
            ...
            <div class="col-md-3">
                ...
                <div class="d-flex">
                    <a href="#" class="social-icon-box me-2"><img src="assets/img/TWITTER.png" alt="Twitter"></a>
